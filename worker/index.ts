    ...
    if (url.pathname === '/api/config') {
      const config = {
        ...
        models: {
          fast: {
            id: 'fast',
            name: 'Fast Mode (Real-ESRGAN INT8)',
            architecture: 'RealESR-AnimeVideoV3 (INT8)',
            scale: 4,
            version: env.DEFAULT_FAST_MODEL_VERSION || 'realesrgan-v3-int8',
            ...
            defaultTileSize: 256,
            overlap: 16,
            description: 'Ultra-compressed INT8 neural network (644 KB). Fast ~0.5s tile processing on CPU and WebGPU.',
          },
          photo: {
            id: 'photo',
            name: 'Photo Mode (Real-ESRGAN INT8)',
            architecture: 'RealESRGAN-x4-INT8',
            scale: 4,
            version: env.DEFAULT_PHOTO_MODEL_VERSION || 'realesrgan-photo-int8',
            ...
            defaultTileSize: 256,
            overlap: 16,
            description: 'Compressed 16.7 MB neural network delivering realistic textures and high fidelity with 3× faster inference.',
          },
        },
        privacyGuarantee: {
